-- MASSIVE SEED DATA FOR SCREENSHOTS
-- WARNING: This will populate your database with a lot of data.
-- IMPORTANT: This script will first WIPE all existing data to prevent duplicate errors.
...
('Amoxicillin 250mg', 'Capsule', 45, 50, 1.20, NOW()), -- LOW STOCK
('Ibuprofen 400mg', 'Tablet', 250, 50, 0.80, NOW()),
('Vitamin C 1000mg', 'Supplement', 1000, 200, 0.30, NOW()),
('Cough Syrup', 'Liquid', 10, 20, 5.00, NOW()), -- LOW STOCK
...
('Amlodipine 5mg', 'Tablet', 0, 50, 0.60, NOW()), -- OUT OF STOCK
...
('Ventolin Inhaler', 'Inhaler', 5, 10, 12.00, NOW()), -- LOW STOCK
...
-- 4. APPOINTMENTS (Schedule for Realism)
-- Note: Adjust IDs based on your actual User/Patient IDs if auto-increment is different.
-- Using Users 1 (House), 2 (Wilson), etc. and Patients 1-30.

-- TODAY (Active Dashboard Data)
